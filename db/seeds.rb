...
Schueler.create(Vorname: "Edward",Name:"Lancaster",Klasse:"6 Gf",
  Mail:"s9362@bks-campus.ch",Number:"s9362",Code:"Site",Registered:false,
  Received:false,password:"Site",password_confirmation:"Site")
